...
class IslamboekhandelSpider(scrapy.Spider):
	name = 'islamboekhandel'
	allowed_domains = ['islamboekhandel.nl']

	def start_requests(self):

		for p in range(1, 100):
			yield scrapy.Request(
				url=f'https://www.islamboekhandel.nl/54-islamboekhandel?page={p}',
